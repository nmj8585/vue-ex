<template>
  ...
  오타내서 죽는줄 -->
    ...
    <!--인라인스타일 주의사항 (오브젝트형)
    카멜케이스로 해라 (처음단어 소문 2번단어 대문)  -->
    <div v-bind:style="[basestyle,addstyle]">인라인 스타일 Binding2</div>
    <!--인라인스타일 주의사항 (배열형)
    카멜케이스로 해라 (처음단어 소문 2번단어 대문)  -->
  </div>
</template>
...
export default {
 data () {
     return {
       ...
       baseStyle: 'background-color:yellow;width:400px;height:200px;',
