<template>
  ...
  <!--computed로 만든  -->
  <!-- 예제로 저렇게 만들수도 있지만 실제  watch의 목적는
       무언가 연산용도가 아니고 우리가선언한 데이터가 있고
        그 데이터가  어떠한 특수한 경우에 어떠한 액션으로 
        인해서 변경될수가 있고 변경사항을 항시 감시하고 
        변경이 일어날때 연산이 아니고 특정 펑션을 수행하고
         -->
</template>
